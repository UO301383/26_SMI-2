...
const MEMBERS = [
  {
    name:      'Mario Hermo',
    username:  'mariohermo',
    email:     'mariohermo@26-smi-2',
    password:  'pass1234',
    video: {
      title:       'Vídeo de Mario Hermo',
      description: 'Vídeo precargado de Mario Hermo',
      file:        'mariohermo.mp4',
    },
  },
  {
    name:      'César Ballesteros',
    username:  'cesarballesteros',
    email:     'cesarballesteros@26-smi-2',
    password:  'pass1234',
    video: {
      title:       'Vídeo de César Ballesteros',
      description: 'Vídeo precargado de César Ballesteros',
      file:        'cesarballesteros.mp4',
    },
  },
  {
    name:      'Carlos Duarte',
    username:  'carlosduarte',
    email:     'carlosduarte@26-smi-2',
    password:  'pass1234',
    video: {
      title:       'Vídeo de Carlos Duarte',
      description: 'Vídeo precargado de Carlos Duarte',
      file:        'carlosduarte.mp4',
    },
  },
];
